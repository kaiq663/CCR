...
def main(opt, opt_sidd, opt_ood):
    ...
    Model = getattr(__import__('model'), opt_sidd['model'])
    model_sidd = Model(opt_sidd)
    model_sidd.data_parallel()
    ...
    def train_step(data):
        # output_atbsn = model_sidd.validation_step(data)
        # output_puca_2 = model_ood.validation_step(data, r3_options=[8,0.16,2])
        output_puca_1 = model_ood.validation_step(data, r3_options=[8,0.16,1])
        model.train_step(data, output_atbsn, output_puca_1)
